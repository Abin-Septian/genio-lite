<template>
    <div>
        <base-header type="gradient-success" class="pb-6 pb-8 pt-5">
            <h1 class="text-white">Pemasukan</h1>
        </base-header>

        <div class="container-fluid mt--7">
            <div class="row">
                <div class="col">
                    <projects-table title="Daftar Pemasukan" :dataPemasukan="data.pemasukan" :organisasi="data.organisasi" :user="data.user" tipe="Pelanggan"></projects-table>
                </div>
            </div>
        </div>
    </div>
...
import ProjectsTable from './Tables/PemasukanTable'
...
export default {
    ...
    created: function (){
        axios.get('https://localhost:8081/v1/pemasukan?id_user=19', {
            headers : {
